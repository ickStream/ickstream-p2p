...
\*-------------------------------------------------------------------------*/
      if( !argptr->valname ) {
        if( value )
          printf( "%s line %d: value for parameter %s ignored!\n",
                  fname, line, keyword );
        (*(int*)argptr->buffer)++;
      }
...
\*-------------------------------------------------------------------------*/
        ...
        *(char **)argptr->buffer = strdup( value );
        ...
        printf( "%s line %d: value for parameter %s expected (line ignored)!\n",
                fname, line, keyword );
...
\*------------------------------------------------------------------------*/
    if( !argptr ) {
      printf( "%s line %d: unknown parameter %s (line ignored)!\n",
              fname, line, keyword );
    }
...
\*-------------------------------------------------------------------------*/
  if( strlen(name)>120 ) {
    printf( "addarg: argument name too long: %s!\n", name );
    return -1;
  }
